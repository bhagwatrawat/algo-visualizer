...
const BubbleSort = () => {
  ...
  return(
    <div ref={ref} className='__selection-sort'>
      ...
      <input type="range" min="10" max="30" step="1" defaultValue={lengthofArray}
